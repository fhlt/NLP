...
'''
en_path = "data/en.txt"
en_vocab_path = "data/en_vocab.txt"
cn_path = "data/cn.txt"
cn_vocab_path = "data/cn_vocab.txt"
embeddingHandler.create_vocab(en_path, en_vocab_path)
print(en_vocab_path)
embeddingHandler.create_vocab(cn_path, cn_vocab_path)
print(cn_vocab_path)
'''
# create en_embedding
'''
